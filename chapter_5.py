...
SCREEN_WIDTH = 800
SCREEN_HEIGHT = 600
SCREEN_TITLE = "2D Temple Run - Level 5"
...
class TempleRunEpisode05(arcade.Window):
    ...
    def setup(self):
        ...
        # Draw the first grassfield on the bottom
        ...
        # Draw the second grassfield on the platform.
        for x in range(SPRITE_SIZE * 3, SPRITE_SIZE * 4, SPRITE_SIZE):
            wall = arcade.Sprite("grassfield.png", SPRITE_SCALING)
        ...
        # -- Draw first enemy on the ground
        ...
        # -- Draw second enemy on the ground
        enemy = arcade.Sprite("goomba.png", SPRITE_SCALING)
        ...
        # -- Draw the first enemy on the first platform
        enemy = arcade.Sprite("goomba.png", SPRITE_SCALING)
        ...
        enemy.boundary_right = SPRITE_SIZE * 11
        enemy.boundary_left = SPRITE_SIZE * 3
        enemy.change_x = 2
        self.enemy_list.append(enemy)

        # -- Draw the second enemy on the first platform
        enemy = arcade.Sprite("goomba.png", SPRITE_SCALING)
        ...
        # -- Draw the third enemy on the first platform
        enemy = arcade.Sprite("goomba.png", SPRITE_SCALING)
        ...
        # -- Draw the first enemy on the second platform
        enemy = arcade.Sprite("goomba.png", SPRITE_SCALING)

        enemy.bottom = SPRITE_SIZE * 6.5
        enemy.left = SPRITE_SIZE * 4
        ...
        # -- Draw the second enemy on the second platform
        enemy = arcade.Sprite("goomba.png", SPRITE_SCALING)
        ...
        # -- Draw the third enemy on the second platform
        enemy = arcade.Sprite("goomba.png", SPRITE_SCALING)
